...
import {
  ...
  CreateSocialAppDto,
} from './enhanced-social-app.service';
...
export class SocialAppsController {
  ...
  async createApp(@Request() req, @Body() createAppDto: CreateAppRequest) {
  ...
  async updateApp(
    ...
    return this.enhancedSocialAppService.updateApp(
      req.user.id,
      appId,
      updateData,
    );
  ...
  async deleteApp(@Request() req, @Param('appId') appId: string) {
   ...
   */ @Post('link-account')
  async linkAccount(@Request() req, @Body() linkData: LinkAccountRequest) {
   ...
   */ @Get(':appId/health')
  async checkAppHealth(@Request() req, @Param('appId') appId: string) {
   ...
   */ @Put(':appId/default')
  async setDefaultApp(@Request() req, @Param('appId') appId: string) {
