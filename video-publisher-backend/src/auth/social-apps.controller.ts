...
export class SocialAppsController {
  ...
  async getUserApps(
    ...
    return this.enhancedSocialAppService.getUserApps(req.user.userId, platform);
  }
  ...
  async createApp(
    ...
    return this.enhancedSocialAppService.createApp(req.user.userId, createAppDto);
  }
  ...
  async updateApp(
    ...
    return this.enhancedSocialAppService.updateApp(req.user.userId, appId, updateData);
  }
  ...
  async deleteApp(
    ...
    await this.enhancedSocialAppService.deleteApp(req.user.userId, appId);
  }
  /**
  ...
  async getUserStats(@Request() req) {
    return this.enhancedSocialAppService.getUserAppStats(req.user.userId);
  }
  ...
  async checkAppsHealth(@Request() req) {
    return this.enhancedSocialAppService.checkUserAppsHealth(req.user.userId);
  }
  ...
  async checkAppHealth(
    ...
    return this.enhancedSocialAppService.checkAppHealth(req.user.userId, appId);
  }
  ...
  async setDefaultApp(
    ...
    return this.enhancedSocialAppService.setDefaultApp(req.user.userId, appId);
  }
